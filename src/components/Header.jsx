...
const Header = () => {
  return (
    ...
    style={{backgroundImage: "url('/header_img.png')"}}  id='Header'>
        ...
        viewport={{once: true}}
         className='container text-center mx-auto py-4 px-6 md:px-20 ld:px-32 text-white'>
            <h2 className='text-5xl sm:text-6xl md:text-[82px] inline-block max-w-3xl font-semibold pt-20'>Find Your Perfect Home at SafeHaven</h2>
