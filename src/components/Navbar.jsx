...
const Navbar = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
        <div className='flex justify-between container mx-auto items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
            <img src={assets.logo_created} className='cursor-pointer'/> 
        ...
        {/* --------- Mobile-Menu -------- */}
        <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0' }  right-0 top-0 bottom-0 overflow-hidden bg-white transition-all duration-200`}>
